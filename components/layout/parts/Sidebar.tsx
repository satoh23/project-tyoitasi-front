        ...
        <aside className="">
          <div className="lg:ml-auto min-w-full w-max flex flex-col lg:h-auto mt-16">
            {nowLogin ? (
              <>
                <Link href="/">
                  <a className="border-b border-border-yellow w-full px-5 py-2 mb-4 mt-4 rounded text-yellow-600 hover:bg-hover-yellow hover:text-white">
                    <svg
              ...
              <>
                ...
                <button
                  className="min-w-max hover:bg-hover-yellow"
